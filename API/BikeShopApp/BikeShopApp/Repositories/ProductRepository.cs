...
namespace BikeShopApp.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<ProductsResponseDto?> GetProductsByPageAsync(string category, string currentPage, string pageResults)
        {
        ...
        public async Task<ProductsResponseDto?> GetFilteredProductsByPageAsync(string category, string currentPage, string pageResults, string price, string rating)
        {
            if (category != null && category != "" && int.TryParse(category, out int categoryParsed))
            {
                if (currentPage != null && currentPage != "" && int.TryParse(currentPage, out int pageParsed))
        ...
        public async Task SetAvgRatingOfProductAsync(int productId)
        {
            var product = await GetProductAsync(productId);
