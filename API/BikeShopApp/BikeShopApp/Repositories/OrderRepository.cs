...
namespace BikeShopApp.Repositories
{
    public class OrderRepository: IOrderRepository
    {
        ...
        public async Task<OrdersResponseDto?> GetOrdersFromUserByPageAsync(int userId, string currentPage, string pageResults)
        {
        ...
        public async Task<User?> GetUserOfOrderAsync(int orderId)
        {
            var order = await _context.Orders.FirstOrDefaultAsync(o => o.OrderId == orderId);
