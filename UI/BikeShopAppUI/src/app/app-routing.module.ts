...
const routes: Routes = [
    ...
    {path: "home", title: "Mega Cycles", component: HomeComponent, resolve: {categoriesData: CategoriesResolver}},
    ...
    {path: "unauthorised", title: "Mega Cycles", component: UnauthorisedComponent},
    {path: "**", title: "Mega Cycles", component: ErrorComponent},
];
