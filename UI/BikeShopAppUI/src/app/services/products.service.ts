...
export class ProductsService {
  ...
  apiUrl: string = "https://localhost:7000/api/products"
  ...
  GetProductsByPage(categoryId: string, currentPage: number, pageResults: number): Observable<ProductsResponse>
  {
  ...
  GetFilteredProductsByPage(categoryId: string, currentPage: number, pageResults: number, price: string, rating: string): Observable<ProductsResponse>
  {
