...
namespace BikeShopApp.Infrastructure.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<(ApplicationUser? user, IEnumerable<string> errors)> CreateUserAsync(ApplicationUser applicationUser, string password)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return (applicationUser, Enumerable.Empty<string>());
            }

            return (null, result.Errors.Select(error => error.Description));
