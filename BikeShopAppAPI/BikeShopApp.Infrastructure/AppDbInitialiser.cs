        ...
        public static async Task Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Users.Any())
                {
                    ...
                    if (admin == null)
                    {
                        throw new Exception("Failed to retrieve the seeded admin user.");
                    }
                    ...
                    if (adminCart == null)
                    {
                        throw new Exception("Failed to create the seeded admin cart.");
                    }
                    ...
                    if (user == null)
                    {
                        throw new Exception("Failed to retrieve the seeded user.");
                    }
                    ...
                    if (userCart == null)
                    {
                        throw new Exception("Failed to create the seeded user cart.");
                    }
