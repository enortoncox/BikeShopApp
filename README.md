...
This will restore the .NET dependencies, install the Angular dependencies, create/update the BikeShopDB database, and apply the EF Core migrations.

Demo seed data is added automatically when the API starts.
...
This starts the ASP.NET Core API and Angular frontend in separate PowerShell windows.
